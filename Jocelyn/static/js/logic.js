...
var southWest2 = L.latLng(40.712, -74.227);
var northEast2 = L.latLng(40.774, -74.125);
var myBounds2 = L.latLngBounds(southWest2, northEast2);
...
d3.json(link).then(function(data){
  ...
  function style(feature2) {
    return {
        fillColor: getColor(feature2.properties.density),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
